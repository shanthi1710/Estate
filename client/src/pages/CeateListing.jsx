     ...
     <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
            <input type="text" placeholder='Name' className='border p-3 rounded-md' id='name' maxLength='62' minLength='10' required />
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <div className='flex gap-4'>
            <input className='p-3 border border-gray-300 rounded-lg rounded-w-full' type='file' id='images' accept='image/*' multiple/>
